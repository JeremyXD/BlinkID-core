...
/**
 * @enum OcrFont
 * @brief List of fonts supported by Blink OCR engine.
 */
enum OcrFont {
    OCR_FONT_AKZIDENZ_GROTESK = 0,
    OCR_FONT_ARIAL,
    ...
    OCR_FONT_UKDL_LIGHT,
    OCR_FONT_COUNT /* must be last as it holds the number of available fonts */
};

/**
 * @brief Typedef for OcrFont enum
 */
typedef MB_EXPORTED_TYPE enum OcrFont OcrFont;
