...
#ifndef PDF417_RESULT_INCLUDED
#define PDF417_RESULT_INCLUDED
 ...
 * @return non-zero value if given result is non-NULL and generated by PDF417 recognizer, zero otherwise
 */
MB_API int MB_CALL recognizerResultIsPdf417Result( const RecognizerResult* result );
